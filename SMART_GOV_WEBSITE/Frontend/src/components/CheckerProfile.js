...
const CheckerProfile = () => {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            try {
                const res = await axios.get('http://localhost:5000/api/checker/profile', {
    ...
    const handleSubmit = async () => {
        try {
            ...
            await axios.put(`http://localhost:5000/api/checker/update/${user._id}`, updatedData, {
                headers: { Authorization: `Bearer ${token}` }
            });
        ...
        <div className="checker-profile-container">
            ...
            <div className="profile-box">
                <div className="profile-left">
                    <img src={`http://localhost:5000/uploads/${user.photo}`} alt="Profile" />
                    ...
                    <p><strong>Gov ID Proof:</strong>
                        <a
                            href={`http://localhost:5000/uploads/${user.govIdCard}`}
                            target="_blank"
